...
func SetupAPI() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "56709a17867692", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "7978903137a7d5", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-replay@greenlight.dev>", "SMTP sender")
	...
	expvar.Publish("goruntines", expvar.Func(func() interface{} {
